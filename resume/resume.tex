...
\address
{
    ...
    Up-to-date resume: \url{https://github.com/rish987/Application-Documents/blob/master/resume/resume.pdf}\\
}
...
\employer{UC Scholars Program, UC San Diego}
...
\employer{UC San Diego CSE Department}
\location{La Jolla, CA}
